...
public class SalesPerson implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject salesPersonMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "MyFirstModule.SalesPerson";
	...
	public SalesPerson(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected SalesPerson(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject salesPersonMendixObject)
	{
		if (salesPersonMendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, salesPersonMendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.salesPersonMendixObject = salesPersonMendixObject;
	 ...
	 */
	public static myfirstmodule.proxies.SalesPerson initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new myfirstmodule.proxies.SalesPerson(context, mendixObject);
	}

	public static myfirstmodule.proxies.SalesPerson load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return myfirstmodule.proxies.SalesPerson.initialize(context, mendixObject);
	}

	public static java.util.List<myfirstmodule.proxies.SalesPerson> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> myfirstmodule.proxies.SalesPerson.initialize(context, obj))
	 ...
	 * @return value of MonthlySalary
	 */
	public final java.math.BigDecimal getMonthlySalary(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.math.BigDecimal) getMendixObject().getValue(context, MemberNames.MonthlySalary.toString());
	}
	 ...
	 * @param monthlysalary
	 */
	public final void setMonthlySalary(java.math.BigDecimal monthlysalary)
	{
	 ...
	 * @param monthlysalary
	 */
	public final void setMonthlySalary(com.mendix.systemwideinterfaces.core.IContext context, java.math.BigDecimal monthlysalary)
	{
	...
	{
		return salesPersonMendixObject;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final myfirstmodule.proxies.SalesPerson that = (myfirstmodule.proxies.SalesPerson) obj;
